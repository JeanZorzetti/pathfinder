...
O verdadeiro poder do ISTJ está em sua capacidade de transformar caos em ordem, de assumir responsabilidade quando outros fogem, e de perseverar através de qualquer obstáculo com determinação silenciosa mas inabalável. Eles são a fundação sobre a qual tudo mais é construído - e essa fundação nunca falha.`,
  ...
  cognitiveFunctions: [
    {
      ...
      manifestation: 'Se manifesta como memória excepcional para detalhes, valorização de consistência e rotina, e uma abordagem "se não está quebrado, não conserte". ISTJs têm um catálogo mental de experiências que consultam constantemente.',
    },
    {
      position: 'auxiliary',
      name: 'Te',
      ...
      manifestation: 'Aparece como forte ética de trabalho, habilidade de gerenciamento de projetos, e valorização de competência e eficiência. ISTJs implementam sistemas práticos que funcionam e eliminam desperdício.',
    },
    {
      position: 'tertiary',
      name: 'Fi',
      ...
      manifestation: 'Pode aparecer como princípios morais rígidos, lealdade feroz a pessoas e instituições que respeitam, e desconforto quando valores são violados, mesmo que não expressem isso abertamente.',
    },
    {
      position: 'inferior',
      name: 'Ne',
      ...
      manifestation: 'ISTJs frequentemente se sentem desconfortáveis com mudanças súbitas, resistem a novas abordagens não testadas, e podem ter dificuldade em brainstorming ou ver múltiplas possibilidades. Sob stress, podem catastrofizar.',
    },
  ],
    ...
    free: [
      {
        ...
        impact: 'Oportunidades perdidas, conflitos com pessoas que querem inovar, dificuldade em ambientes que mudam rapidamente.',
      },
      {
        ...
        impact: 'Relacionamentos superficiais, acúmulo de stress emocional não processado, parecem frios ou insensíveis.',
      },
      {
        ...
        impact: 'Alienação de pessoas mais criativas ou não-convencionais, reputação de serem rígidos ou antiquados.',
      },
    ],
    gated: {
      full: [
        {
          ...
          impact: 'Burnout, stress crônico, dificuldade em delegar porque ninguém faz "do jeito certo".',
        ...
        },
        {
          ...
          impact: 'Ficar para trás em ambientes que evoluem rapidamente, perder vantagens competitivas, ser visto como obstáculo ao progresso.',
        ...
        },
        {
          ...
          impact: 'Paralisia em situações novas ou únicas, stress em ambientes caóticos, evitar oportunidades que parecem muito incertas.',
        ...
        },
        {
          ...
          impact: 'Relacionamentos deteriorados, burnout, arrependimento posterior sobre tempo não gasto com entes queridos.',
        ...
        },
        {
          ...
          impact: 'Sobrecarga desnecessária, esgotamento, falha em aproveitar recursos disponíveis, isolamento.',
  ...
  famousPeople: [
    { name: 'George Washington', role: 'Primeiro Presidente dos EUA', avatar: 'https://ui-avatars.com/api/?name=George+Washington&background=1E40AF&color=fff' },
    { name: 'Warren Buffett', role: 'Investidor e Filantropo', avatar: 'https://ui-avatars.com/api/?name=Warren+Buffett&background=1E40AF&color=fff' },
    { name: 'Angela Merkel', role: 'Ex-Chanceler da Alemanha', avatar: 'https://ui-avatars.com/api/?name=Angela+Merkel&background=1E40AF&color=fff' },
    { name: 'Denzel Washington', role: 'Ator', avatar: 'https://ui-avatars.com/api/?name=Denzel+Washington&background=1E40AF&color=fff' },
    { name: 'Natalie Portman', role: 'Atriz', avatar: 'https://ui-avatars.com/api/?name=Natalie+Portman&background=1E40AF&color=fff' },
    { name: 'Queen Elizabeth II', role: 'Rainha do Reino Unido', avatar: 'https://ui-avatars.com/api/?name=Queen+Elizabeth&background=1E40AF&color=fff' },
    { name: 'Jeff Bezos', role: 'Fundador da Amazon', avatar: 'https://ui-avatars.com/api/?name=Jeff+Bezos&background=1E40AF&color=fff' },
    { name: 'Condoleezza Rice', role: 'Ex-Secretária de Estado', avatar: 'https://ui-avatars.com/api/?name=Condoleezza+Rice&background=1E40AF&color=fff' },
    { name: 'Anthony Hopkins', role: 'Ator', avatar: 'https://ui-avatars.com/api/?name=Anthony+Hopkins&background=1E40AF&color=fff' },
    { name: 'Evander Holyfield', role: 'Boxeador', avatar: 'https://ui-avatars.com/api/?name=Evander+Holyfield&background=1E40AF&color=fff' },
  ],
      ...
      core: [
        {
          ...
          manifestation: 'Assumem responsabilidade total por ações e resultados; nunca fazem desculpas ou culpam outros.',
        },
        {
          value: 'Tradição e Continuidade',
          description: 'Respeito por instituições, práticas e valores testados pelo tempo.',
          manifestation: 'Valorizam história familiar, tradições organizacionais, e métodos comprovados; relutam em mudar o que funciona.',
        },
        {
          ...
          manifestation: 'Criam e mantêm sistemas organizacionais; desconforto com caos e ambiguidade.',
        },
        {
          value: 'Integridade',
          description: 'Comportamento ético consistente baseado em princípios claros de certo e errado.',
          manifestation: 'Fazem o que é certo mesmo quando difícil; não comprometem valores por conveniência.',
        },
        {
          value: 'Competência',
          description: 'Domínio de habilidades e conhecimento em área de responsabilidade.',
          manifestation: 'Trabalham incansavelmente para melhorar expertise; respeitam e recompensam competência em outros.',
        },
      ],
      conflicts: {
