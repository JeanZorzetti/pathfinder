...
O verdadeiro poder do ENFP está em sua capacidade de ver o melhor nas pessoas, de conectar ideias e indivíduos de maneiras inesperadas, e de inspirar outros através de seu entusiasmo genuíno e visão otimista. Eles são os catalisadores de mudança, os construtores de pontes entre pessoas e ideias, e os lembretes vibrantes de que a vida deve ser vivida com paixão e propósito.`,
  ...
  famousPeople: [
    { name: 'Robin Williams', role: 'Ator e Comediante', avatar: 'https://ui-avatars.com/api/?name=Robin+Williams&background=EC4899&color=fff' },
    { name: 'Ellen DeGeneres', role: 'Apresentadora e Comediante', avatar: 'https://ui-avatars.com/api/?name=Ellen+DeGeneres&background=EC4899&color=fff' },
    { name: 'Will Smith', role: 'Ator e Músico', avatar: 'https://ui-avatars.com/api/?name=Will+Smith&background=EC4899&color=fff' },
    { name: 'Robert Downey Jr.', role: 'Ator', avatar: 'https://ui-avatars.com/api/?name=Robert+Downey+Jr&background=EC4899&color=fff' },
    { name: 'Quentin Tarantino', role: 'Diretor e Roteirista', avatar: 'https://ui-avatars.com/api/?name=Quentin+Tarantino&background=EC4899&color=fff' },
    { name: 'Russell Brand', role: 'Comediante e Ativista', avatar: 'https://ui-avatars.com/api/?name=Russell+Brand&background=EC4899&color=fff' },
    { name: 'Drew Barrymore', role: 'Atriz e Produtora', avatar: 'https://ui-avatars.com/api/?name=Drew+Barrymore&background=EC4899&color=fff' },
    { name: 'Sandra Bullock', role: 'Atriz', avatar: 'https://ui-avatars.com/api/?name=Sandra+Bullock&background=EC4899&color=fff' },
    { name: 'Walt Disney', role: 'Empreendedor Criativo', avatar: 'https://ui-avatars.com/api/?name=Walt+Disney&background=EC4899&color=fff' },
    { name: 'Mark Twain', role: 'Escritor e Humorista', avatar: 'https://ui-avatars.com/api/?name=Mark+Twain&background=EC4899&color=fff' },
  ],
