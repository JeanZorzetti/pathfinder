  ...
  cognitiveFunctions: [
    {
      ...
      details: 'Se manifesta como entusiasmo contagiante por novas ideias, habilidade de ver conexões entre conceitos aparentemente não relacionados, e uma mente que constantemente pergunta "e se?" e "o que mais é possível?". ENFPs são brainstormers naturais que energizam grupos com sua criatividade.',
    },
    {
      position: 'auxiliary',
      name: 'Fi',
      ...
      details: 'Aparece como forte senso de autenticidade, necessidade de agir de acordo com valores pessoais, empatia profunda, e habilidade de entender as emoções e motivações dos outros em nível intuitivo. ENFPs sabem instantaneamente se algo "parece certo" para eles.',
    },
    {
      position: 'tertiary',
      name: 'Te',
      ...
      details: 'Pode aparecer em explosões de produtividade organizada, especialmente quando um projeto alinha com valores (Fi). ENFPs podem ser surpreendentemente eficientes quando motivados, mas lutam para manter essa organização consistentemente.',
    },
    {
      position: 'inferior',
      name: 'Si',
      ...
      details: 'ENFPs frequentemente lutam com rotinas, esquecem detalhes práticos importantes, podem negligenciar necessidades físicas quando focados em possibilidades, e têm dificuldade em aprender com erros passados da mesma forma repetida.',
    },
  ],
